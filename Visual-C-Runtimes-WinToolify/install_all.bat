...
echo.
echo Microsoft Visual C++ Runtime Hepsi Bir Arada Paket by Burak Arslan
echo https://burakarslan.me
echo https://github.com/burakarslan0110/WinToolify
echo.
echo Paketler kurulmaya basliyor...
